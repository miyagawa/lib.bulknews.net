...
var ENDSHOW_MESG="スライド ショーの最後です。 クリックすると終了します。", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=48, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0050.htm", 1, 32),
   new hrefList("slide0032.htm", 1, 33),
   new hrefList("slide0033.htm", 1, 34),
   new hrefList("slide0034.htm", 1, 35),
   ...
   new hrefList("slide0044.htm", 1, 43),
   new hrefList("slide0045.htm", 1, 44),
   new hrefList("slide0047.htm", 1, 45),
   new hrefList("slide0046.htm", 1, 46),
   new hrefList("slide0048.htm", 1, 47),
   new hrefList("slide0049.htm", 1, 48)
);
